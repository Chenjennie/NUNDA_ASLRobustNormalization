...
try
    for resource= dir(sprintf('%s/sequence*',asl_base))
        ...
        load('/projects/p20394/software/pipeline_external/NUNDA_ASLRobustNormalization/coreg.mat');
      %  load('/home/yfc938/software/coreg.mat');
        ...
        test2=load('/projects/p20394/software/pipeline_external/NUNDA_ASLRobustNormalization/VBMest.mat');
